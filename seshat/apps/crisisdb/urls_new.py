...
urlpatterns += [
    ...
    path('land_taxes_collecteds/', views.Land_taxes_collectedListView.as_view(), name='land_taxes_collecteds'),
...
urlpatterns += [
    ...
    path('total_taxes/', views.Total_taxListView.as_view(), name='total_taxes'),
...
urlpatterns += [
    ...
    path('total_economic_outputs/', views.Total_economic_outputListView.as_view(), name='total_economic_outputs'),
...
urlpatterns += [
    ...
    path('total_revenues/', views.Total_revenueListView.as_view(), name='total_revenues'),
...
urlpatterns += [
    ...
    path('diding_taxes/', views.Diding_taxesListView.as_view(), name='diding_taxes'),
...
urlpatterns += [
    ...
    path('salt_taxes/', views.Salt_taxListView.as_view(), name='salt_taxes'),
...
urlpatterns += [
    ...
    path('tariff_and_transits/', views.Tariff_and_transitListView.as_view(), name='tariff_and_transits'),
...
urlpatterns += [
    ...
    path('misc_incomes/', views.Misc_incomesListView.as_view(), name='misc_incomes'),
...
urlpatterns += [
    ...
    path('total_expenditures/', views.Total_expenditureListView.as_view(), name='total_expenditures'),
...
urlpatterns += [
    ...
    path('maritime_customs/', views.Maritime_customListView.as_view(), name='maritime_customs'),
...
urlpatterns += [
    ...
    path('other_incomes/', views.Other_incomesListView.as_view(), name='other_incomes'),
...
urlpatterns += [
    ...
    path('revenue_officials/', views.Revenue_officialListView.as_view(), name='revenue_officials'),
...
urlpatterns += [
    ...
    path('gdp_growth_rates/', views.Gdp_growth_rateListView.as_view(), name='gdp_growth_rates'),
...
urlpatterns += [
    ...
    path('shares_of_world_gdps/', views.Shares_of_world_gdpListView.as_view(), name='shares_of_world_gdps'),
...
urlpatterns += [
    ...
    path('rate_of_gdp_per_capita_growths/', views.Rate_of_gdp_per_capita_growthListView.as_view(), name='rate_of_gdp_per_capita_growths'),
...
urlpatterns += [
    ...
    path('wages/', views.WagesListView.as_view(), name='wages'),
...
urlpatterns += [
    ...
    path('annual_wages/', views.Annual_wagesListView.as_view(), name='annual_wages'),
...
urlpatterns += [
    ...
    path('rate_of_returns/', views.Rate_of_returnListView.as_view(), name='rate_of_returns'),
...
urlpatterns += [
    ...
    path('disease_events/', views.Disease_eventListView.as_view(), name='disease_events'),
...
urlpatterns += [
    ...
    path('jinshi_degrees_awardeds/', views.Jinshi_degrees_awardedListView.as_view(), name='jinshi_degrees_awardeds'),
...
urlpatterns += [
    ...
    path('taiping_rebellions/', views.Taiping_rebellionListView.as_view(), name='taiping_rebellions'),
