...
class GADMShapefile(models.Model):
    ...
    GID_0=models.CharField(max_length=50, null=True)
    NAME_0=models.CharField(max_length=50, null=True)
    VARNAME_0=models.CharField(max_length=50, null=True)
    GID_1=models.CharField(max_length=50, null=True)
    NAME_1=models.CharField(max_length=50, null=True)
    VARNAME_1=models.CharField(max_length=50, null=True)
    NL_NAME_1=models.CharField(max_length=50, null=True)
    ISO_1=models.CharField(max_length=50, null=True)
    HASC_1=models.CharField(max_length=50, null=True)
    CC_1=models.CharField(max_length=50, null=True)
    TYPE_1=models.CharField(max_length=50, null=True)
    ENGTYPE_1=models.CharField(max_length=50, null=True)
    VALIDFR_1=models.CharField(max_length=50, null=True)
    GID_2=models.CharField(max_length=50, null=True)
    NAME_2=models.CharField(max_length=50, null=True)
    VARNAME_2=models.CharField(max_length=50, null=True)
    NL_NAME_2=models.CharField(max_length=50, null=True)
    HASC_2=models.CharField(max_length=50, null=True)
    CC_2=models.CharField(max_length=50, null=True)
    TYPE_2=models.CharField(max_length=50, null=True)
    ENGTYPE_2=models.CharField(max_length=50, null=True)
    VALIDFR_2=models.CharField(max_length=50, null=True)
    GID_3=models.CharField(max_length=50, null=True)
    NAME_3=models.CharField(max_length=50, null=True)
    VARNAME_3=models.CharField(max_length=50, null=True)
    NL_NAME_3=models.CharField(max_length=50, null=True)
    HASC_3=models.CharField(max_length=50, null=True)
    CC_3=models.CharField(max_length=50, null=True)
    TYPE_3=models.CharField(max_length=50, null=True)
    ENGTYPE_3=models.CharField(max_length=50, null=True)
    VALIDFR_3=models.CharField(max_length=50, null=True)
    GID_4=models.CharField(max_length=50, null=True)
    NAME_4=models.CharField(max_length=50, null=True)
    VARNAME_4=models.CharField(max_length=50, null=True)
    CC_4=models.CharField(max_length=50, null=True)
    TYPE_4=models.CharField(max_length=50, null=True)
    ENGTYPE_4=models.CharField(max_length=50, null=True)
    VALIDFR_4=models.CharField(max_length=50, null=True)
    GID_5=models.CharField(max_length=50, null=True)
    NAME_5=models.CharField(max_length=50, null=True)
    CC_5=models.CharField(max_length=50, null=True)
    TYPE_5=models.CharField(max_length=50, null=True)
    ENGTYPE_5=models.CharField(max_length=50, null=True)
    GOVERNEDBY=models.CharField(max_length=50, null=True)
    SOVEREIGN=models.CharField(max_length=50, null=True)
    DISPUTEDBY=models.CharField(max_length=50, null=True)
    REGION=models.CharField(max_length=50, null=True)
    VARREGION=models.CharField(max_length=50, null=True)
    COUNTRY=models.CharField(max_length=50, null=True)
    CONTINENT=models.CharField(max_length=50, null=True)
    SUBCONT=models.CharField(max_length=50, null=True)
